...
namespace RoomEnglish.Infrastructure.Migrations
{
    ...
    [Migration("20251022103020_AddVietnameseMeaningToVocabularyWord")]
    partial class AddVietnameseMeaningToVocabularyWord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RoomEnglish.Domain.Entities.VocabularyCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Color = "Blue",
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 98, DateTimeKind.Unspecified).AddTicks(930), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                        ...
                        new
                        {
                            Id = 2,
                            Color = "Green",
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 98, DateTimeKind.Unspecified).AddTicks(1480), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                        ...
                        new
                        {
                            Id = 3,
                            Color = "Purple",
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 98, DateTimeKind.Unspecified).AddTicks(1487), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
            ...
            modelBuilder.Entity("RoomEnglish.Domain.Entities.VocabularyExample", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 99, DateTimeKind.Unspecified).AddTicks(4055), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            DifficultyLevel = 1,
                            DisplayOrder = 1,
                        ...
                        {
                            Id = 2,
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 99, DateTimeKind.Unspecified).AddTicks(4063), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            DifficultyLevel = 1,
                            DisplayOrder = 1,
                        ...
                        {
                            Id = 3,
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 99, DateTimeKind.Unspecified).AddTicks(4065), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            DifficultyLevel = 2,
                            DisplayOrder = 2,
                        ...
                        {
                            Id = 4,
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 99, DateTimeKind.Unspecified).AddTicks(4067), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            DifficultyLevel = 2,
                            DisplayOrder = 1,
            ...
            modelBuilder.Entity("RoomEnglish.Domain.Entities.VocabularyWord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CorrectCount = 0,
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 100, DateTimeKind.Unspecified).AddTicks(5438), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            CorrectCount = 0,
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 100, DateTimeKind.Unspecified).AddTicks(5445), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CorrectCount = 0,
                            Created = new DateTimeOffset(new DateTime(2025, 10, 22, 10, 30, 20, 100, DateTimeKind.Unspecified).AddTicks(5448), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
