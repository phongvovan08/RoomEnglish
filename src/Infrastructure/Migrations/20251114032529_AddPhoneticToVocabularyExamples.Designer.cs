...
namespace RoomEnglish.Infrastructure.Migrations
{
    ...
    [Migration("20251114032529_AddPhoneticToVocabularyExamples")]
    partial class AddPhoneticToVocabularyExamples
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoomEnglish.Domain.Entities.AudioCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CacheKeyHash")
                        .IsRequired()
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("HitCount", "LastAccessedAt")
            ...
            modelBuilder.Entity("RoomEnglish.Domain.Entities.UserCategoryProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ExamplesCompleted")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserCategoryProgress");
                });

            modelBuilder.Entity("RoomEnglish.Domain.Entities.UserExampleProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FastestTimeSeconds")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("VocabularyExampleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "ExampleId")
                        .IsUnique();

                    b.ToTable("UserExampleProgress");
                });

            modelBuilder.Entity("RoomEnglish.Domain.Entities.UserLearningPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LastExampleIndex")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserLearningPositions");
                });
            ...
            modelBuilder.Entity("RoomEnglish.Domain.Entities.VocabularyCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Color = "Blue",
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 566, DateTimeKind.Unspecified).AddTicks(257), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                        ...
                        new
                        {
                            Id = 2,
                            Color = "Green",
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 566, DateTimeKind.Unspecified).AddTicks(2014), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                        ...
                        new
                        {
                            Id = 3,
                            Color = "Purple",
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 566, DateTimeKind.Unspecified).AddTicks(2032), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
            ...
            modelBuilder.Entity("RoomEnglish.Domain.Entities.VocabularyExample", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 570, DateTimeKind.Unspecified).AddTicks(4043), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            DifficultyLevel = 1,
                            DisplayOrder = 1,
                        ...
                        {
                            Id = 2,
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 570, DateTimeKind.Unspecified).AddTicks(4071), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            DifficultyLevel = 1,
                            DisplayOrder = 1,
                        ...
                        {
                            Id = 3,
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 570, DateTimeKind.Unspecified).AddTicks(4079), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            DifficultyLevel = 2,
                            DisplayOrder = 2,
                        ...
                        {
                            Id = 4,
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 570, DateTimeKind.Unspecified).AddTicks(4086), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            DifficultyLevel = 2,
                            DisplayOrder = 1,
            ...
            modelBuilder.Entity("RoomEnglish.Domain.Entities.VocabularyWord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CorrectCount = 0,
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 574, DateTimeKind.Unspecified).AddTicks(5187), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            CorrectCount = 0,
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 574, DateTimeKind.Unspecified).AddTicks(5220), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CorrectCount = 0,
                            Created = new DateTimeOffset(new DateTime(2025, 11, 14, 3, 25, 28, 574, DateTimeKind.Unspecified).AddTicks(5229), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
            ...
            modelBuilder.Entity("RoomEnglish.Domain.Entities.UserExampleProgress", b =>
                {
                    ...
                    b.HasOne("RoomEnglish.Domain.Entities.VocabularyExample", null)
